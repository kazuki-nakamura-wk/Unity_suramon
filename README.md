...
##動画デモ
[YouTubeで見る(約２分)](https://youtu.be/RWEE49lm2Ks)

>ゲームの流れ(敵にぶつかる⇒バグ発生⇒相性の悪い攻撃⇒敵を倒せない⇒クリア)を紹介する短いデモ映像です。

※バグ発生について、現在確認されている不具合として、スライムが攻撃オブジェクトにぶつかると進行方向がズレ、壁をすり抜けてステージ外へ出てしまう問題があります。
ステージ外に出たスライムは止まらず、無限ループ状態になります。
この動画では、たまたま敵との衝突によって停止し、オーバー演出のように見えています。
...
|スライム|属性|対応キー|説明|
|赤スライム|炎|'1'|炎属性の攻撃。草タイプに強い。|
|青スライム|水|'2'|水属性の攻撃。炎タイプに強い。|
|黄緑スライム|草|'3'|草属性の攻撃。水タイプに強い。|
